# Conduital — Codex Instructions

This file provides context and instructions for Codex when working on this project.
...
- **AI Integration**: Anthropic Codex API
...
*This file is automatically read by Codex at session start.*
